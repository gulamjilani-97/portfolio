...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="min-h-screen flex items-center relative pt-20" style={{ backgroundColor: '#ffffff' }}>
      <div className="absolute inset-0 bg-gradient-to-br from-secondary-200 to-secondary-300 -z-10" />
      
      <div className="container mx-auto px-4 font-mono text-black">
        <div className="flex flex-col items-center justify-center text-center">
          <motion.span 
            className="inline-block py-1 px-3 rounded-full bg-primary-light/10 text-black text-sm font-medium mb-6"
          ...
          <motion.p 
            className="text-lg max-w-2xl mb-8 text-black/70"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
